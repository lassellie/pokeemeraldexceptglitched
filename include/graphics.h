...
extern const u32 gMonFrontPic_Graith[];
extern const u32 gMonPalette_Graith[];
extern const u32 gMonBackPic_Graith[];
extern const u32 gMonShinyPalette_Graith[];
extern const u32 gMonStillFrontPic_Graith[];
extern const u8 gMonIcon_Graith[];
extern const u8 gMonFootprint_Graith[];
extern const u32 gMonFrontPic_Empish[];
extern const u32 gMonPalette_Empish[];
extern const u32 gMonBackPic_Empish[];
extern const u32 gMonShinyPalette_Empish[];
extern const u32 gMonStillFrontPic_Empish[];
extern const u8 gMonIcon_Empish[];
extern const u8 gMonFootprint_Empish[];
extern const u32 gMonFrontPic_Slarck[];
extern const u32 gMonPalette_Slarck[];
extern const u32 gMonBackPic_Slarck[];
extern const u32 gMonShinyPalette_Slarck[];
extern const u32 gMonStillFrontPic_Slarck[];
extern const u8 gMonIcon_Slarck[];
extern const u8 gMonFootprint_Slarck[];
extern const u32 gMonFrontPic_Kelvitten[];
extern const u32 gMonPalette_Kelvitten[];
extern const u32 gMonBackPic_Kelvitten[];
extern const u32 gMonShinyPalette_Kelvitten[];
extern const u32 gMonStillFrontPic_Kelvitten[];
extern const u8 gMonIcon_Kelvitten[];
extern const u8 gMonFootprint_Kelvitten[];
