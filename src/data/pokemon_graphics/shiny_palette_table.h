const struct CompressedSpritePalette gMonShinyPaletteTable[] =
{
	...
	SPECIES_SHINY_PAL(GRAITH, gMonShinyPalette_Graith),
	SPECIES_SHINY_PAL(EMPISH, gMonShinyPalette_Empish),
	SPECIES_SHINY_PAL(SLARCK, gMonShinyPalette_Slarck),
	SPECIES_SHINY_PAL(KELVITTEN, gMonShinyPalette_Kelvitten),
