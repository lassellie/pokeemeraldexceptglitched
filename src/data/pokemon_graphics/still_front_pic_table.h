...
// Gen III
	...
	SPECIES_SPRITE(GRAITH,      gMonStillFrontPic_Graith),
	SPECIES_SPRITE(EMPISH,		  gMonStillFrontPic_Empish),
	SPECIES_SPRITE(SLARCK,		  gMonStillFrontPic_Slarck),
	SPECIES_SPRITE(KELVITTEN,		  gMonStillFrontPic_Kelvitten),
