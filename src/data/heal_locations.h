static const struct HealLocation sHealLocations[] =
{
    ...
    {MAP_GROUP(SPLENDALE), MAP_NUM(SPLENDALE), 5, 17},
    {MAP_GROUP(BURROWSVILLE), MAP_NUM(BURROWSVILLE), 14, 20},
    {MAP_GROUP(BURROWSVILLEUPER), MAP_NUM(BURROWSVILLEUPER), 24, 14},
    {MAP_GROUP(MORPHON), MAP_NUM(MORPHON), 0, 0},
};
