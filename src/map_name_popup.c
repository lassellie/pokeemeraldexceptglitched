...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
	...
	[MAPSEC_SPLENDALE] = MAPPOPUP_THEME_WOOD,
	[MAPSEC_YVELD] = MAPPOPUP_THEME_STONE,
	[MAPSEC_YVELD_MINE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_MINING_CAVE] = MAPPOPUP_THEME_STONE,
	[MAPSEC_SECLUDED_FOREST] = MAPPOPUP_THEME_WOOD
};
